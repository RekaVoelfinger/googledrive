...
def transform_input(input_file_name):
    # OBSOLATE
    # folder_id = '1t7H5baSoNLZA_B5XZ-L6WYWDRw2sxdU9'  # Shared with me/Struktur Gitarre 2020 03
    folder_id = "'1viyaI3nIim2UvWv1H2eAWcOONCW4UWaw'"  # My Drive/Loerinc_Gitarre
    file_name_list = ""
    ...
    file_name_list = f"{folder_id} in parents and (" + file_name_list[:-4] + ")"
